...
abstract class BaseAutomailerPeer {
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = AutomailerPeer::getOMClass(false);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseAutomailerPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseAutomailerPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new AutomailerTableMap());
	  }
	}
	...
	{
		return $withPrefix ? AutomailerPeer::CLASS_DEFAULT : AutomailerPeer::OM_CLASS;
	}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			AutomailerPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Automailer) { // it's a model object
...
//
BaseAutomailerPeer::buildTableMap();
